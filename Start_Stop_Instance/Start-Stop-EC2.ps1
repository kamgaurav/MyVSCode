...
New-AWSPowerShellLambda -ScriptName EC2InstanceStop -Template Basic
Publish-AWSPowerShellLambda -ScriptPath .\RDPLockDown\RDPLockDown.ps1 -Name  EC2InstanceStop -Region us-east-1 -IAMRoleArn $NewIAMRole.Arn
